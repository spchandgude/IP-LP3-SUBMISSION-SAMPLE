...
boolean newFileFlag;
String fileName;
String applicationTitle="TextEditor";
...
fileHandler=new Operations(this);
...
findReplaceDialog.showDialog(TextEditor.this.f,true);//find
}
...
if(findReplaceDialog==null)
	findReplaceDialog=new FindDialog(TextEditor.this.ta);
findReplaceDialog.showDialog(TextEditor.this.f,false);
...
createCheckBoxMenuItem(viewStatusBar,KeyEvent.VK_S,viewMenu,this).setSelected(true);
 LookMenu.createLookAndFeelMenuItem(viewMenu,this.f);
