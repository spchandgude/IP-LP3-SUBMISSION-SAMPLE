...
public class Notepad implements ActionListener, MenuConstants {
	...
	String applicationName = "Saurabh";
...
interface MenuConstants {
	...
	final String helpAboutNotepad = "About TextEditor";

	final String aboutText = "<html><big>PVRasal</big><hr><hr>"
			+ "<hr><em><big>prajaktarasal0199@gmail.com</big></em><hr><html>";
}